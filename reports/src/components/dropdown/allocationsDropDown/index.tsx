...
function AllocationsDropDownFilter() {
  ...
  const [dropdownStatus, setDropdownStatus] = useState(['Confirmed']);
    ...
    <div ref={catMenu}>
      <div className="relative flex justify-start px-1">
        <button
          ...
          className="border-2 rounded-md border-blue-500 font-medium  px-3 py-[4px] text-center inline-flex justify-center items-center text-blue-500 hover:text-blue-500 hover:bg-blue-200"
          type="button"
        >
          <span className="flex text-[14px] font-semi-bold pr-1">Allocations: </span>
          ...
          <div className="grid grid-rows-3  grid-flow-col">
            <div className="flex items-center whitespace-nowrap">
              <input
                ...
                type="checkbox"
                defaultChecked
                onChange={() => setChecked((prev) => ({ ...prev, confirmed: !prev.confirmed }))}
                value=""
...
export default AllocationsDropDownFilter;
