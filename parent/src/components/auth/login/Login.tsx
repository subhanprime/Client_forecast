...
import login from '../../../media/svgs/login.svg';
      ...
      <div>
        <div className="h-32 flex flex-row items-center justify-between px-10">
          ...
          <div className=" flex items-center flex-row gap-4  cursor-pointer z-10">
            <div>New to Float? </div>
            <button className="bg-indigo-100/60 hover:bg-indigo-200 text-indigo-700 px-3 py-1 rounded" onClick={() => navigate('/signup')}>Try for free</button>
          </div>
        </div>
        <div className="min-h-screen flex items-center justify-center absolute w-full top-0 bottom-0">
          ...
          <div className="p-8 rounded-lg shadow-lg bg-white w-[450px]">
            ...
            <div className="mt-4 text-center">
              <div>
                Forgot password ?
                <span className="text-blue-400 hover:underline"> Reset</span>
              </div>
            </div>
          </div>
        </div>
